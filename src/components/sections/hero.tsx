    ...
    <section className="relative overflow-hidden bg-grid">
      ...
      <div className="mx-auto max-w-7xl px-4 py-28 sm:px-6 sm:py-36 lg:px-8 lg:py-44">
        <div className="mx-auto max-w-4xl text-center">
          {/* Headline */}
          <h1 className="animate-fade-in-up font-heading text-4xl font-extrabold tracking-tight text-foreground sm:text-5xl md:text-6xl lg:text-[5.5rem] lg:leading-[1.05]">
          ...
          {/* Subtext */}
          <p className="animate-fade-in-up animate-delay-200 mx-auto mt-8 max-w-2xl text-lg leading-relaxed text-muted-foreground sm:text-xl">
          ...
          {/* CTAs */}
          <div className="animate-fade-in-up animate-delay-300 mt-12 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link
              href="/register"
              className={cn(
                buttonVariants({ size: "lg" }),
                "gap-2 px-8 py-3 text-base font-semibold glow-primary card-hover"
              )}
            >
              Create Free Account
              <ArrowRight size={18} />
            ...
            <Link
              ...
              className={cn(
                ...
                "px-8 py-3 text-base font-semibold card-hover"
              )}
            >
              Log In
            </Link>
          ...
          {/* Stats */}
          <div className="animate-scale-in animate-delay-500 mx-auto mt-20 grid max-w-3xl grid-cols-2 gap-6 sm:grid-cols-4 rounded-2xl border-2 border-primary/30 bg-card/50 p-6 sm:p-8 shadow-sm backdrop-blur-sm">
            {[
